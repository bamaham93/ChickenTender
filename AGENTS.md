# AI Coding Rules - ChickenTender Repository

This document consolidates all AI coding rules and guidelines from the ChickenTender repository. You can apply these same rules to other repositories by copying the relevant sections.
...
*This document was extracted from the ChickenTender repository's CONTRIBUTING.md and .github/copilot-instructions.md files.*